...
export const players = [
    new Personagem(
     ...
     new Personagem(
        ...
        new Progresso(5, 283, 46.5, 1, 86, 83.00),
       ),
    /*###########################################*/
    new Personagem(
        "Davizinho", "---", 
        ...
        new Progresso(0, 198, 39.6, 0, 0, 0.50),
       ),
    /*###########################################*/
    new Personagem(
        "Ernani", "Necron", 
        ...
        new Progresso(1, 166, 31.6, 2, 37, 75.48),
       ),
    /*###########################################*/
    //nivel, xp, skill, upgrade, missao, gold
    new Personagem(
        ...
        new Progresso(0, 395, 35.2, 1, 6, 1.50),
       ),
    /*###########################################*/
    new Personagem(
        "Lucas Black", "Naguine", 
        ...
        new Progresso(0, 708, 20.6, 7, 12, 141.28),
       ),
    /*###########################################*/
    new Personagem(
        "Lucas White", "Enel", 
        ...
        new Progresso(1, 481, 11.9, 0, 23, 1.00),
       ),
    /*###########################################*/
    new Personagem(
        "Lyann Black", "Lucius", 
        ...
        new Progresso(1, 788, 32.2, 3, 16, 71.50),
       ),
    /*###########################################*/
    new Personagem(
        "Lyann Nix", "Neko", 
        ...
        new Progresso(5, 731, 8.6, 2, 92, 79.20),
       ),
    /*###########################################*/
    new Personagem(
        "Niket", "Kazuma", 
        ...
        new Progresso(2, 170, 20.7, 0, 39, 122.00),
       ),
    /*###########################################*/
    new Personagem(
        "Uilian", "Aldritch", 
        ...
        new Progresso(0, 208, 4.6, 1, 1, 0.50),
       ),
    /*###########################################*/
    //dia 67 -> 198 XP e 39.6 Skill 
];
